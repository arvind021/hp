...
def extract_features(closes):
    ...
    # FIX: zero/invalid candles filter karo — yfinance kabhi 0 deta hai
    ...
    try:
        ...
        # FIX: safe division helper
        def pct(a, b): return (a - b) / b * 100 if b and b != 0 else 0.0
        ...
        return [
            ...
            c1, c2, c3,
            vol_ratio,
            pct(closes[-1], closes[-3]),
            pct(closes[-1], closes[-5]),
        ]
    except Exception as e:
